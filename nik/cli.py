...
def build_parser() -> argparse.ArgumentParser:
    ...
    rechunk.add_argument(
        ...
        type=int,
        default=None,
        help="Max characters per chunk (default: reuse manifest or 50)",
    )
    rechunk.add_argument(
        "--min-chars",
        type=int,
    ...
    synth.add_argument("--max-chars", type=int, default=50)
    ...
    sample.add_argument("--max-chars", type=int, default=50)
